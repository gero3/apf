...
var gotoFirst = function(){
    first.unshift("require");
    define(first,gotoSecond);
};
var required;
var gotoSecond = function(require){
    second.unshift("require");
    required = require;
    require(second,gotoThird);
};

var gotoThird = function(require){
    third.unshift("require");
    required(third,gotoFourth);
};

var gotoFourth = function(require){
    fourth.unshift("require");
    required(fourth,gotoFifth);
};

var gotoFifth = function(require){
    fifth.unshift("require");
    required(fifth,gotoSix);
};

var gotoSix = function(require){
    six.unshift("require");
    required(six,gotoSeven);
};

var gotoSeven = function(require){
    seven.unshift("require");
    required(seven,gotoEight);
};

var gotoEight = function(require){
    eight.unshift("require");
    required(eight,gotoNine);
};

var gotoNine = function(require){
    nine.unshift("require");
    required(nine,gotoTen);
};

var gotoTen = function(require){
    ten.unshift("require");
    required(ten,gotoEleven);
};

var gotoEleven = function(require){
    required(eleven,end);
};
